...
const { getUserContacts, add, update, remove, getById, getContacts, getContactByCategories, addMany, getNotRequestedContacts, sendContactDetailsEmail, updateSubmittedInfoSearch, updateLastGeneratedInfoSearch } = require('./contact.controller')
...
router.post('/updateSubmittedInfoSearch', verifyTokenAndAdmin, updateSubmittedInfoSearch)
router.post('/updateLastGeneratedInfoSearch', verifyTokenAndAdmin, updateLastGeneratedInfoSearch)
